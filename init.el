...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (avy yaml-mode tide multiple-cursors adaptive-wrap zerodark-theme markdown-mode swiper web-mode transpose-frame tern smartparens projectile keyfreq js2-refactor ido-vertical-mode hungry-delete groovy-mode flx-ido fill-column-indicator epc elpy diminish dash-functional beacon auto-complete aggressive-indent ac-js2)))
