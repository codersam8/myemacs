...
(define-minor-mode my-overriding-minor-mode
  ...
  `((,(kbd "C-d") . my-delete-word)))
(define-minor-mode my-overriding-minor-mode
  "Most superior minir mode"
  t  ;; default is enable
  "" ;; Not display mode-line
  `((,(kbd "C-j") . ido-switch-buffer)))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (color-theme-sanityinc-solarized color-theme-solarized solarized-theme java-snippets web-mode transpose-frame tern smartparens projectile magit keyfreq js2-refactor ido-vertical-mode hungry-delete groovy-mode flx-ido fill-column-indicator epc elpy diminish dash-functional color-theme-sanityinc-tomorrow beacon auto-package-update auto-complete aggressive-indent ac-js2)))
